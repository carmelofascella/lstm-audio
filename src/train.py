...
# default dataset is a  dataset made with a simple audacity distortion effect
ap.add_argument("-d", "--dataset", default="dataset/", help="dataset folder containing input and output folder")
ap.add_argument("-s", "--hidden_size", default=32, help="hidden size of the lstm")

args = vars(ap.parse_args())
audio_folder = args["dataset"]
...
test_file = f"{audio_folder}/test_guitar.wav"
